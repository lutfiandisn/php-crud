    ...
    <div class="content">
        <div class="card-login">
            <div class="card-main">
                ...
                <div class="card-body">
                    <form class="form-login" method="POST" action="<?= BASE_URL . 'process/login.php' ?>">
                    ...
                    <div class="register-link">
                        <p>Belum punya akun? <a href="<?= BASE_URL . 'views/auth/register.php' ?>" class="btn btn-register">Register</a></p>
                    </div>
                </div>
            </div>
        </div>
