...
$daftarPembelian = $productController->getAllPembelianProduct();
?>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active text-primary" aria-current="page" href="pembelian.php">Pembelian</a>
                    </li>
                    <li class="nav-item">
